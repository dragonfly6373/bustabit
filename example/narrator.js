var config = {
  ...
  sayGameStarting: {
    value: false,
    type: "checkbox",
    label: "narrate GAME_STARTING events?",
  },
  sayGameStarted: {
    value: true,
    type: "checkbox",
    label: "narrate GAME_STARTED events?",
  },
  sayGameEnded: {
    value: true,
    type: "checkbox",
    label: "narrate GAME_ENDED events?",
  },
  sayBetPlaced: {
    value: true,
    type: "checkbox",
    label: "narrate own BET_PLACED events?",
  },
  sayCashedOut: {
    value: true,
    type: "checkbox",
    label: "narrate own CASHED_OUT events?",
  },
  sayGameTick: {
    value: true,
    type: "checkbox",
    label: "narrate GAME_TICK events?",
  },
  otherUsers: {
    value: "",
    type: "text",
    label: "Other users (comma separated)",
    optional: true,
  },
  sayOtherBets: {
    value: false,
    type: "checkbox",
    label: "narrate other users' bets?",
  },
  sayOtherCashOuts: {
    value: true,
    type: "checkbox",
    label: "narrate other users' cash-outs?",
  },
};
